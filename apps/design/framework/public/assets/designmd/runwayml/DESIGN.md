...
id: runwayml
source: crawled
source_url: https://github.com/voltagent/awesome-design-md/blob/main/design-md/runwayml/DESIGN.md
source_date: '2026-05-01'
title: Design System Inspired by Runway
summary: 'Runway''s interface is a cinematic reel brought to life as a website — a
  dark, editorial, film-production-grade design where full-bleed photography and video
  ARE the primary UI elements. This is not a typical tech product page; it''s a visual
