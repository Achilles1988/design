...
id: airtable
source: crawled
source_url: https://github.com/voltagent/awesome-design-md/blob/main/design-md/airtable/DESIGN.md
source_date: '2026-05-17'
title: Airtable-design-analysis
summary: A sober, editorial workflow-software interface anchored on white canvas and
  dark-ink type, where brand voltage comes from full-bleed signature cards in coral,
